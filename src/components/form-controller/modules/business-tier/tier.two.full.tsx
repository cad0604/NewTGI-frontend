...
const informationImportant = {
  title: "IMPORTANT",
  content: "Don’t proceed to the next  step  until trade accounts are reporting.",
  color: "gray",
}
          ...
          <div className="flex flex-col w-[76%] justify-start mt-6">
            ...
            <div className="flex flex-col w-full px-2 justify-center items-center content-center mt-6">
              ...
              <div className="flex w-full text-gray-500 justify-center text-center mt-4">
                <p>You need <b className="text-gray-700">at least 6 trade accounts</b> reporting on your business credit reports to move to, “Tier 3”. Please scroll apply for trade accounts.</p>
              </div>
