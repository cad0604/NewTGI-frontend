...
const alertContent = "The Goal of Step 2.1 is to apply for your DUNS number if you don’t already have it, and to verify the address listed for your D&B account";
...
const contentBlogCardLeft = {
    ...
    contents: [
        {
            dataString: "It’s important for a business to have a business address. In order to have a strong business foundation, your business should use a physical business address. Most lenders prefer that you have a business address but, you can use your residential address.",
            dataColor: "",
            dataSize: "",
        },
        {
            dataString: "VERY IMPORTANT when applying for your DUNS number to use the exact same company name and business address as the Secretary of State and IRS. Creditors will check the business information on your report against public record. If there are any variances, it can lead to a decline.",
...
const contentSelect = {
    contents1: "Does dun &bradstreet list the exact same company name and business address as the secretary  of state and irs ? ",
}
                ...
                <div className="flex flex-col w-[76%] justify-start mt-6">
                    ...
                    <div className="flex flex-col w-full px-2 justify-center items-center content-center mt-6">
                        ...
                        <div className="flex w-[60%] mt-8">
                            ...
                            <span className="inline-box ml-1"> to update your business name & address  with</span>
                        ...
                        <div className="flex w-[60%]">
                            <span className="inline-block">so it matches exactly with the Secretary of State & IRS</span>
                        </div>
                        ...
                        <div className="flex flex-row w-[85%] mt-12">
                            <div className="flex w-[50%] justify-center">
                                <GeneralCard icon="/report/init/Export.svg" content="Apply for a D&N Number" />
                            </div>
                            <div className="flex w-[50%] justify-center">
                                <GeneralCard icon="/report/init/Chart.svg" content="D&N basic report information" />
                            </div>
                        </div>
