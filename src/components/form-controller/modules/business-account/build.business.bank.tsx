...
const contentBlogCardLeft = {
    ...
    content: "All businesses big or small, new or established should set up a business bank account. A business bank account opens up financing options. Additionally, a business bank account affects the business in both accounting and legal departments.",
}
            ...
            <div className="flex flex-row w-[80%] ml-[10%] mt-10 justify-center border-2 border-blue-400 p-6 rounded-2xl">
                ...
                <div className="flex flex-col w-[76%] justify-start mt-6">
                    ...
                    <div className="flex flex-col w-full px-2 justify-center items-center content-center mt-6">
                        <ArrowLineText type="flex flex-col w-[80%] text-center text-gray-700" content="DO YOU HAVE A BUSINESS BANK ACCOUNT?" />
                        {/* Vidio card */}
